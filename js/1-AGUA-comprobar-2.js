...
if (Respuesta4=="PD"){
	...
	if ((Respuesta5=="240.5")||(Respuesta5=="240,5")){
	...
	if (exito=="true"){
		...
		document.getElementById("Codigo").innerHTML="CONSEGUIDO EN EL INTENTO " + contador+ ".<br> COORDENADAS: (1,-3). <br> BUSCAR EL PUNTO MEDIO DEL RECTÁNGULO";
		document.getElementById("Codigo").style='display:block';
