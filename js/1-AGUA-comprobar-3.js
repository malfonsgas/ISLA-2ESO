...
if (Respuesta4=="PD"){
	...
	if ((Respuesta5=="277.5") || (Respuesta5=="277,5")){
	...
	if (exito=="true"){
		...
		document.getElementById("Codigo").innerHTML="CONSEGUIDO EN EL INTENTO " + contador+ ".<br> COORDENADAS: (5,-1). <br> BUSCAR EL PUNTO MEDIO DEL RECTÁNGULO";
		document.getElementById("Codigo").style='display:block';
