...
if (Respuesta4=="PD"){
	...
	if ((Respuesta5=="10.656") || (Respuesta5=="10,656")){
	...
	if (exito=="true"){
		...
		document.getElementById("Codigo").innerHTML="CONSEGUIDO EN EL INTENTO " + contador+ ".<br> COORDENADAS: (5,-3). <br> BUSCAR EL PUNTO MEDIO DEL RECTÁNGULO";
		document.getElementById("Codigo").style='display:block';
