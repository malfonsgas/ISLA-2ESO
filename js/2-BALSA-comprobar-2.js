...
function PLANTILLAcomprobar(){
	...
	if ((Respuesta7=="510,4") || (Respuesta7=="510.4")){
	...
	if (exito=="true"){
		...
		document.getElementById("Codigo").innerHTML="CONSEGUIDO EN EL INTENTO " + contador+ ".<br> COORDENADAS: (-1,5). <br> BUSCAR EL PUNTO RECTA CORTA EJE Y";
